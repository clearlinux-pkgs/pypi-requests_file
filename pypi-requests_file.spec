...
Source0  : https://files.pythonhosted.org/packages/2b/69/ba1b5f52f96cde4f2d8eca74a0aa2c11a66b2fe58d0fb63b2e46edce6ed3/requests-file-2.0.0.tar.gz
...
%prep
%setup -q -n requests-file-2.0.0
cd %{_builddir}/requests-file-2.0.0
pushd ..
cp -a requests-file-2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708369016
...
cp %{_builddir}/requests-file-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-requests_file/6ece8941471a5843511a796d798cbb6ac05be6f7 || :
